...
- REQ-032 — `controls.segment-tempo`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-033 — `controls.bar-aware-count-in`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-034 — `controls.per-sheet-metronome-presets`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).

...
key-files:
  created:
    - ".planning/phases/05-pack-5-library-viewer-upgrade/05-01-PLAN.md"
    - ".planning/phases/05-pack-5-library-viewer-upgrade/05-01-SUMMARY.md"
  modified: []
key-decisions:
...
- REQ-020 — `library.tags-favorites`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-021 — `library.batch-import`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-022 — `library.recent-practice-summary`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-023 — `library.review-by-sheet`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-028 — `viewer.page-thumbnails`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-029 — `viewer.multi-page-jump`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-030 — `viewer.advanced-zoom-pan`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-031 — `viewer.assisted-page-turning`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).

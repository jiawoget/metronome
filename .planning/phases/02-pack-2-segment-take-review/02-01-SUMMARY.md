...
- REQ-016 — `recordings.review-grouping`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-017 — `recordings.tags-favorites-archive`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-018 — `recordings.recording-comparison`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-019 — `recordings.audio-export`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-035 — `takes.multi-take-management`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-036 — `takes.active-best-take`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-037 — `takes.take-history`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-038 — `takes.waveform-comparison`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).

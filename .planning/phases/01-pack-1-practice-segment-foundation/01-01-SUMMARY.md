...
key-files:
  created:
    - ".planning/phases/01-pack-1-practice-segment-foundation/01-01-PLAN.md"
    - ".planning/phases/01-pack-1-practice-segment-foundation/01-01-SUMMARY.md"
  modified: []
key-decisions:
...
- REQ-024 — `practice.measure-grid`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-025 — `practice.practice-segments`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-026 — `practice.segment-recording`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).
- REQ-027 — `practice.segment-rerecording`; runtime and automated evidence are linked in [REQUIREMENTS.md](../../REQUIREMENTS.md).

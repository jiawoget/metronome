# Requirements Archive: v1.0 Legacy Delivered Baseline

**Archived:** 2026-07-20
**Status:** SHIPPED

This file preserves the shipped v1.0 requirements snapshot.
...
This completed-only staging archive retains the 32 product capabilities supported by reachable runtime and automated evidence. At archival time, Pending capabilities were intentionally excluded from milestone requirements and described by the non-phase table in [ROADMAP.md](v1.0-ROADMAP.md). That table is an archival snapshot, not current authority. Current deferred truth resides in dormant native seeds until a matching requirement is approved and its seed is deleted in the same planning commit under the approved one-carrier rule.

### 01 App Shell Home

- [x] **REQ-004**: Users can view truthful aggregate local practice totals on Home.
  - Feature key: `home.dashboard-analytics`
  - Contract: [`docs/legacy/v1/01-app-shell-home.md`](../../docs/legacy/v1/01-app-shell-home.md)
  - Imported phase: [Phase 3: pack-3-sessions-continue-practice](v1.0-ROADMAP.md#phase-3-pack-3-sessions-continue-practice)
...
- [x] **REQ-016**: Users can review sheet recordings grouped into sheet and segment take histories, with quick recordings separately reviewable in the same review system.
  ...
  - Contract: [`docs/legacy/v1/03-recordings-review.md`](../../docs/legacy/v1/03-recordings-review.md)
  - Imported phase: [Phase 2: pack-2-segment-take-review](v1.0-ROADMAP.md#phase-2-pack-2-segment-take-review)
...
- [x] **REQ-020**: Users can tag, favorite, search, and filter locally imported sheets.
  ...
  - Contract: [`docs/legacy/v1/04-sheet-library.md`](../../docs/legacy/v1/04-sheet-library.md)
  - Imported phase: [Phase 5: pack-5-library-viewer-upgrade](v1.0-ROADMAP.md#phase-5-pack-5-library-viewer-upgrade)
...
- [x] **REQ-024**: Users can calibrate and persist a deterministic measure-to-time grid for a sheet.
  ...
  - Contract: [`docs/legacy/v1/05f-practice-segments.md`](../../docs/legacy/v1/05f-practice-segments.md)
  - Imported phase: [Phase 1: pack-1-practice-segment-foundation](v1.0-ROADMAP.md#phase-1-pack-1-practice-segment-foundation)
...
- [x] **REQ-028**: Users can navigate a multi-page sheet through generated page thumbnails.
  ...
  - Contract: [`docs/legacy/v1/05a-sheet-viewer.md`](../../docs/legacy/v1/05a-sheet-viewer.md)
  - Imported phase: [Phase 5: pack-5-library-viewer-upgrade](v1.0-ROADMAP.md#phase-5-pack-5-library-viewer-upgrade)
...
- [x] **REQ-032**: Users can apply a selected segment's target tempo to the practice metronome.
  ...
  - Contract: [`docs/legacy/v1/05b-practice-controls.md`](../../docs/legacy/v1/05b-practice-controls.md)
  - Imported phase: [Phase 4: pack-4-practice-controls-upgrade](v1.0-ROADMAP.md#phase-4-pack-4-practice-controls-upgrade)
...
- [x] **REQ-035**: Users can manage repeated recordings as one segment take group.
  ...
  - Contract: [`docs/legacy/v1/05c-sheet-recording-review.md`](../../docs/legacy/v1/05c-sheet-recording-review.md)
  - Imported phase: [Phase 2: pack-2-segment-take-review](v1.0-ROADMAP.md#phase-2-pack-2-segment-take-review)
  - Runtime: [`src/lib/recordings-review/take-groups.ts`](../../src/lib/recordings-review/take-groups.ts)
  - Evidence: [`tests/unit/recordings-review-take-groups.test.ts`](../../tests/unit/recordings-review-take-groups.test.ts)
...
- [x] **REQ-045**: Local practice activity is evaluated against configured practice goals.
  ...
  - Contract: [`docs/legacy/v1/05e-session-integration.md`](../../docs/legacy/v1/05e-session-integration.md)
  - Imported phase: [Phase 3: pack-3-sessions-continue-practice](v1.0-ROADMAP.md#phase-3-pack-3-sessions-continue-practice)
  - Runtime: [`src/domain/practice/rules.ts`](../../src/domain/practice/rules.ts)
  - Evidence: [`tests/unit/practice-goal-service.test.ts`](../../tests/unit/practice-goal-service.test.ts)
...
- [x] **REQ-059**: Users can compare compatible local practice sessions using truthful metrics.
  ...
  - Contract: [`docs/legacy/v1/08-practice-session.md`](../../docs/legacy/v1/08-practice-session.md)
  - Imported phase: [Phase 3: pack-3-sessions-continue-practice](v1.0-ROADMAP.md#phase-3-pack-3-sessions-continue-practice)
...
| Item | Reason |
|------|--------|
| 32 pending capabilities | The ROADMAP table records the archival-time source only; current deferred truth resides in dormant seeds until promotion under the approved one-carrier rule. |
...
|-------------|-------------|-------|--------|
| REQ-004 | `home.dashboard-analytics` | [Phase 3](v1.0-ROADMAP.md#phase-3-pack-3-sessions-continue-practice) | Complete |
| REQ-005 | `home.practice-streaks` | [Phase 3](v1.0-ROADMAP.md#phase-3-pack-3-sessions-continue-practice) | Complete |
| REQ-006 | `home.goal-management` | [Phase 3](v1.0-ROADMAP.md#phase-3-pack-3-sessions-continue-practice) | Complete |
| REQ-007 | `home.recent-activity-timeline` | [Phase 3](v1.0-ROADMAP.md#phase-3-pack-3-sessions-continue-practice) | Complete |
| REQ-008 | `home.continue-practice-recommendations` | [Phase 3](v1.0-ROADMAP.md#phase-3-pack-3-sessions-continue-practice) | Complete |
| REQ-009 | `home.command-palette` | [Phase 3](v1.0-ROADMAP.md#phase-3-pack-3-sessions-continue-practice) | Complete |
| REQ-016 | `recordings.review-grouping` | [Phase 2](v1.0-ROADMAP.md#phase-2-pack-2-segment-take-review) | Complete |
| REQ-017 | `recordings.tags-favorites-archive` | [Phase 2](v1.0-ROADMAP.md#phase-2-pack-2-segment-take-review) | Complete |
| REQ-018 | `recordings.recording-comparison` | [Phase 2](v1.0-ROADMAP.md#phase-2-pack-2-segment-take-review) | Complete |
| REQ-019 | `recordings.audio-export` | [Phase 2](v1.0-ROADMAP.md#phase-2-pack-2-segment-take-review) | Complete |
| REQ-020 | `library.tags-favorites` | [Phase 5](v1.0-ROADMAP.md#phase-5-pack-5-library-viewer-upgrade) | Complete |
| REQ-021 | `library.batch-import` | [Phase 5](v1.0-ROADMAP.md#phase-5-pack-5-library-viewer-upgrade) | Complete |
| REQ-022 | `library.recent-practice-summary` | [Phase 5](v1.0-ROADMAP.md#phase-5-pack-5-library-viewer-upgrade) | Complete |
| REQ-023 | `library.review-by-sheet` | [Phase 5](v1.0-ROADMAP.md#phase-5-pack-5-library-viewer-upgrade) | Complete |
| REQ-024 | `practice.measure-grid` | [Phase 1](v1.0-ROADMAP.md#phase-1-pack-1-practice-segment-foundation) | Complete |
| REQ-025 | `practice.practice-segments` | [Phase 1](v1.0-ROADMAP.md#phase-1-pack-1-practice-segment-foundation) | Complete |
| REQ-026 | `practice.segment-recording` | [Phase 1](v1.0-ROADMAP.md#phase-1-pack-1-practice-segment-foundation) | Complete |
| REQ-027 | `practice.segment-rerecording` | [Phase 1](v1.0-ROADMAP.md#phase-1-pack-1-practice-segment-foundation) | Complete |
| REQ-028 | `viewer.page-thumbnails` | [Phase 5](v1.0-ROADMAP.md#phase-5-pack-5-library-viewer-upgrade) | Complete |
| REQ-029 | `viewer.multi-page-jump` | [Phase 5](v1.0-ROADMAP.md#phase-5-pack-5-library-viewer-upgrade) | Complete |
| REQ-030 | `viewer.advanced-zoom-pan` | [Phase 5](v1.0-ROADMAP.md#phase-5-pack-5-library-viewer-upgrade) | Complete |
| REQ-031 | `viewer.assisted-page-turning` | [Phase 5](v1.0-ROADMAP.md#phase-5-pack-5-library-viewer-upgrade) | Complete |
| REQ-032 | `controls.segment-tempo` | [Phase 4](v1.0-ROADMAP.md#phase-4-pack-4-practice-controls-upgrade) | Complete |
| REQ-033 | `controls.bar-aware-count-in` | [Phase 4](v1.0-ROADMAP.md#phase-4-pack-4-practice-controls-upgrade) | Complete |
| REQ-034 | `controls.per-sheet-metronome-presets` | [Phase 4](v1.0-ROADMAP.md#phase-4-pack-4-practice-controls-upgrade) | Complete |
| REQ-035 | `takes.multi-take-management` | [Phase 2](v1.0-ROADMAP.md#phase-2-pack-2-segment-take-review) | Complete |
| REQ-036 | `takes.active-best-take` | [Phase 2](v1.0-ROADMAP.md#phase-2-pack-2-segment-take-review) | Complete |
| REQ-037 | `takes.take-history` | [Phase 2](v1.0-ROADMAP.md#phase-2-pack-2-segment-take-review) | Complete |
| REQ-038 | `takes.waveform-comparison` | [Phase 2](v1.0-ROADMAP.md#phase-2-pack-2-segment-take-review) | Complete |
| REQ-045 | `sessions.goal-completion` | [Phase 3](v1.0-ROADMAP.md#phase-3-pack-3-sessions-continue-practice) | Complete |
| REQ-059 | `practice-session.session-comparison` | [Phase 3](v1.0-ROADMAP.md#phase-3-pack-3-sessions-continue-practice) | Complete |
| REQ-060 | `practice-session.duration-rules` | [Phase 3](v1.0-ROADMAP.md#phase-3-pack-3-sessions-continue-practice) | Complete |

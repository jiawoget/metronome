...
This completed-only staging archive retains the 32 product capabilities supported by reachable runtime and automated evidence. Pending capabilities are intentionally excluded from milestone requirements and persist as non-phase Backlog rows in [ROADMAP.md](v1.0-ROADMAP.md).

# Requirements Archive: v1.1 Repository Formatting Baseline

**Archived:** 2026-08-01
**Status:** SHIPPED

This is the immutable v1.1 requirement record. A later milestone creates a fresh `.planning/REQUIREMENTS.md` rather than reusing this archive.

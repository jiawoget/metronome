...
- v0 is a light, focused practice workspace.
- v0 avoids marketing-page composition.
- v0 keeps Sheet Practice visually centered on the sheet.
...
- Richer responsive layouts for tablets.

## Required v0 Boundaries to Preserve

- Practice actions remain clear.
...
Promote v1 visual features only after:

- v0 core modules are verified.
- The new visual feature has real user value.
- Layout and resize tests are defined.

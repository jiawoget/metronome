...
- Sync-aware continue-practice service after cloud sync exists.

## Testing Implications

- E2E tests for goal creation and dashboard navigation.
- Cross-device resume tests after sync exists.
...
- Cross-device resume depends on sync correctness.

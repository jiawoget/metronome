...
The boundary review's former implementation plan, [`R-01-sheet-rerecord-source-validation.md`](../../v1/implementation-slices/plans/R-01-sheet-rerecord-source-validation.md), and the later isolated [Lumen historical pilot](../../superpowers/plans/2026-07-20-lumen-r01-opengsd-pilot.md) are both superseded evidence. Current authority is `.planning/STATE.md` and `.planning/ROADMAP.md`: after governance merge, the real R01 starts from updated `main` through native OpenGSD. This register does not authorize execution.
